  ...
  render() {
    return(
      <div>
        ...
        <div id="home-input">
          <textarea id="crypto-input" onChange={this.props.onChange}></textarea><br></br>
